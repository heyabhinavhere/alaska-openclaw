...
| `send_channel` | Channel post via the outbox. Public-channel sends are external-ish — only on rung-0/approved chains (watcher-creator gates this at creation). |
